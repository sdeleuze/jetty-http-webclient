...
import org.springframework.test.experimental.jdkclient.Pojo;

import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertThat;
import static org.junit.Assert.assertTrue;

public class JettyWebClientIntegrationTests {
	...
	@Test
	public void shouldReceivePlainTextMono() throws Exception {
	...
	public void shouldReceiveJsonAsFluxPojo() throws Exception {
		...
		StepVerifier.create(result)
				.consumeNextWith(p -> assertThat(p.getBar(), CoreMatchers.is("bar1")))
				.consumeNextWith(p -> assertThat(p.getBar(), CoreMatchers.is("bar2")))
				.expectComplete()
				.verify(Duration.ofSeconds(3));
